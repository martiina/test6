...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta charset="UTF-8" />
		<title>Test 6 veebileht - Registreeri</title>
		...
		<!-- Validation skript on siin (ajax). Hoiame register.php vaate puhtana. -->
		<script src="assets/js/validation.js"></script>
	</head>
	<body>
		<?php include_once 'includes/menu.php'; ?>
		<div class="container">
			<?php if(Session::exists('register-success')): ?>
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						<p class="alert alert-success"><?php echo Session::flash('register-success'); ?></p>
					</div>
				</div>
			<?php endif; ?>
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<form action="ajax.php" method="POST" id="register-form">
					  	...
					  	<div class="form-group" id="check-password-group">
					    	<label class="control-label" for="password">Korda parooli</label>
					    	<input type="password" class="form-control" id="check-password" name="check-password" placeholder="Korda parooli" />
					    	<p class="help-block hidden" id="check-password-error"></p>
					  	</div>
					  	<button type="submit" class="btn btn-danger">Registreeri</button>
